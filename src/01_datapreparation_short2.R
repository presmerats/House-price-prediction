...
# featureset 2
# no logs, no ratios,  no log ratios
# this feature subset will not contain any derived vars and it's original version
data2 <- data.new[,c(1:24)]
data2 <- data2[,c(-14,-15,-22,-23)]
names(data2)
save(data2, file = "data-featureset-2.Rdata")

# featureset 3
# logs, no ratios, no log ratios
data3 <- data.new[,c(1:24,35:45)]
data3 <- data3[,c(1,7,8,13,16,17,20,21,24:35)]
names(data3)
save(data3, file = "data-featureset-3.Rdata")
...
names(data4)
save(data4, file = "data-featureset-4.Rdata")
...
names(data5)
save(data5, file = "data-featureset-5.Rdata")

# featureset 6
# combinations of normal, log, ratios but avoiding correlated ones
